...
//     from: "Ap"
// }
// function getDetails(food,city){
//     return this.name
// }
// console.log(getDetails.bind(meena),"hamunapuram","chicken")
...
//apply methhod is used to call a method of an object with another object as an argument.
//  The only difference between call and apply is that call takes arguments separately whereas apply takes arguments as an array.
...
let shivansh = {
  ...
  let muktai = {
   ...
   muktai.getDetails.apply(muktai, ["Jammu", "Rajma"]);
   console.log(muktai)
